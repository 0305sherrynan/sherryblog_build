import { version, useSSRContext, getCurrentInstance, effectScope, ref, markRaw, inject, watchEffect, watch, defineComponent, mergeProps, createApp, reactive, unref, h, Suspense, nextTick, Transition, computed, provide, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRef, shallowRef, isReadonly, defineAsyncComponent, isRef } from 'vue';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./index-475aa4a6.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "app" }, _attrs))} data-v-d8e635a4>`);
...
const AppComponent = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-d8e635a4"]]);
const _sfc_main = {
  __name: "nuxt-root",
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./error-component-48ac000d.mjs').then((r) => r.default || r));
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./island-renderer-83225f79.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
